...
PROTOBUF_CONSTEXPR RpcHeader::RpcHeader(
  ...
  , /*decltype(_impl_.args_length_)*/0u
...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::xgrpc::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::xgrpc::RpcHeader, _impl_.service_name_),
  PROTOBUF_FIELD_OFFSET(::xgrpc::RpcHeader, _impl_.method_name_),
  PROTOBUF_FIELD_OFFSET(::xgrpc::RpcHeader, _impl_.args_length_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::xgrpc::RpcHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::xgrpc::_RpcHeader_default_instance_._instance,
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\005xgrpc\"K\n\tRpcHeader\022\024\n"
...
const ::_pbi::DescriptorTable descriptor_table_rpcheader_2eproto = {
    false, false, 109, descriptor_table_protodef_rpcheader_2eproto,
    "rpcheader.proto",
...
RpcHeader::RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:xgrpc.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  _this->_impl_.args_length_ = from._impl_.args_length_;
  // @@protoc_insertion_point(copy_constructor:xgrpc.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:xgrpc.RpcHeader)
...
// @@protoc_insertion_point(message_clear_start:xgrpc.RpcHeader)
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          _impl_.args_length_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:xgrpc.RpcHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // uint32 args_length = 3;
  if (this->_internal_args_length() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(3, this->_internal_args_length(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:xgrpc.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:xgrpc.RpcHeader)
  size_t total_size = 0;
  ...
  // uint32 args_length = 3;
  if (this->_internal_args_length() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_args_length());
  }
...
void RpcHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:xgrpc.RpcHeader)
  ...
  if (from._internal_args_length() != 0) {
    _this->_internal_set_args_length(from._internal_args_length());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void RpcHeader::CopyFrom(const RpcHeader& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:xgrpc.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void RpcHeader::InternalSwap(RpcHeader* other) {
  ...
  swap(_impl_.args_length_, other->_impl_.args_length_);
}
...
template<> PROTOBUF_NOINLINE ::xgrpc::RpcHeader*
Arena::CreateMaybeMessage< ::xgrpc::RpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::xgrpc::RpcHeader >(arena);
}
