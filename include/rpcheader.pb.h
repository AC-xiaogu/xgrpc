...
PROTOBUF_NAMESPACE_OPEN
template<> ::xgrpc::RpcHeader* Arena::CreateMaybeMessage<::xgrpc::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace xgrpc {
...
class RpcHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xgrpc.RpcHeader) */ {
 public:
  ...
  uint32_t args_length() const;
  void set_args_length(uint32_t value);
  private:
  uint32_t _internal_args_length() const;
  void _internal_set_args_length(uint32_t value);
  public:

  // @@protoc_insertion_point(class_scope:xgrpc.RpcHeader)
 private:
  class _Internal;
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:xgrpc.RpcHeader.service_name)
...
void RpcHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.service_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xgrpc.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:xgrpc.RpcHeader.service_name)
  return _s;
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:xgrpc.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:xgrpc.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:xgrpc.RpcHeader.method_name)
...
void RpcHeader::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.method_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xgrpc.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:xgrpc.RpcHeader.method_name)
  return _s;
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:xgrpc.RpcHeader.method_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xgrpc.RpcHeader.method_name)
}
...
inline uint32_t RpcHeader::_internal_args_length() const {
  return _impl_.args_length_;
}
inline uint32_t RpcHeader::args_length() const {
  // @@protoc_insertion_point(field_get:xgrpc.RpcHeader.args_length)
  return _internal_args_length();
}
inline void RpcHeader::_internal_set_args_length(uint32_t value) {
  
  _impl_.args_length_ = value;
}
inline void RpcHeader::set_args_length(uint32_t value) {
  _internal_set_args_length(value);
  // @@protoc_insertion_point(field_set:xgrpc.RpcHeader.args_length)
}
